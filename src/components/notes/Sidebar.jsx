      ...
      >
        ...
        {note.id === currentNote.id && (
          <button
            ...
            className="bg-none border-none text-red-700 mr-4 hidden group-hover:block"
          >
